...
global paramsIN abr_FIG abr_Stimuli abr_root_dir abr_data_dir hearingStatus animal data ...
    han invert abr_out_dir freq date dataFolderpath
...
if (ismac == 1) %MAC computer
    ...
    abr_out_dir= '/Volumes/Heinz-Lab/Users/Hannah/ARO_2018_MEMR_TTS/Analysis/ABR/';
...
%     abr_out_dir= 'Y:\Users\Hannah\ARO_2018_MEMR_TTS\Analysis\ABR\Output_ThrPeak_HGcopy\'; %change back !!
    abr_out_dir = 'Y:\Users\Hannah\ARO_2018_MEMR_TTS\Analysis\ABR\';
end
...
elseif strcmp(command_str,'directory')
    abr_Stimuli.dir = get_directory_noAR;
