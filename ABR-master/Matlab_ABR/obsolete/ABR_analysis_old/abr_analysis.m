...
if nargin < 1
    ...
    push = cell2struct(cell(1,4),{'process','print','file','edit'},2);
    ...
    eval('get_analysis_ins'); %script creates struct Stimuli
    ...
    FIG.push.edit    = uicontrol(FIG.handle,'style','edit','Units','normalized','position',[.32 .1 .1 .05],'string',[],'FontSize',12);								
...
elseif strcmp(command_str,'file')
    ...
    if isempty(filename)
        ...
        print('-depsc','-noui',fullfile(pic_dir,char(filename))); % might crash the computer!!!!
