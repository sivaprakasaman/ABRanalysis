...
FIG.ax2.ProgMess = text(.5,.5,'Push to begin averaging...','fontsize',12,'fontangle','normal','fontweight','normal','color',[.6 .1 .1],'verticalalignment','middle','horizontalalignment','center','EraseMode','back');
