...
abr_FIG.push.freq500 = uicontrol(abr_FIG.handle,'callback','abr_analysis_HL(''freq_proc'',0.5);','style','pushbutton','Units','normalized','position',...
    [freq_load.x 0.28 freq_load.width freq_load.height],'string','500Hz');
abr_FIG.push.freq1k = uicontrol(abr_FIG.handle,'callback','abr_analysis_HL(''freq_proc'',1);','style','pushbutton','Units','normalized','position',...
    [freq_load.x 0.245 freq_load.width freq_load.height],'string','1kHz');
abr_FIG.push.freq2k = uicontrol(abr_FIG.handle,'callback','abr_analysis_HL(''freq_proc'',2);','style','pushbutton','Units','normalized','position',...
    [freq_load.x 0.21 freq_load.width freq_load.height],'string','2kHz');
abr_FIG.push.freq4k = uicontrol(abr_FIG.handle,'callback','abr_analysis_HL(''freq_proc'',4);','style','pushbutton','Units','normalized','position',...
    [freq_load.x 0.175 freq_load.width freq_load.height],'string','4kHz');
abr_FIG.push.freq8k = uicontrol(abr_FIG.handle,'callback','abr_analysis_HL(''freq_proc'',8);','style','pushbutton','Units','normalized','position',...
    [freq_load.x 0.14 freq_load.width freq_load.height],'string','8kHz');
abr_FIG.push.freqClick= uicontrol(abr_FIG.handle,'callback','abr_analysis_HL(''freq_proc'',0);','style','pushbutton','Units','normalized','position',...
