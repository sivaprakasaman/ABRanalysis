...
global num freq spl animal date freq_level data abr ABRmag w hearingStatus

default = strcat('chin',animal,'_',hearingStatus,'_',date);
figure(22); set(gcf,'Units','normalized','Position',[0.5 0.5 0.2 0.1])
text(0,0,['saving to file:' default])
