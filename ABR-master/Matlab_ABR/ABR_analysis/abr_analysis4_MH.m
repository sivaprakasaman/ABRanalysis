function abr_analysis4_MH(command_str,parm_num)
...
% abr_data_dir = 'Y:\Users\Hannah\ARO_2018_MEMR_TTS\Data\Q348\ABR\pre\1weekPreTTS';
% abr_data_dir = 'Y:\Users\Hannah\ARO_2018_MEMR_TTS\Data\Q348\ABR\post\2weeksPostTTS';
abr_out_dir= 'Y:\Users\Hannah\ARO_2018_MEMR_TTS\Analysis\ABR\Output_ThrPeak\';
...
if nargin < 1
    ...
    abr_gui_initiate_MH; %% Makes the GUI visible   %% Apr16_2019_MH_HG: USE new subscript with new abr_anlaysis version to callback NEW gui file
